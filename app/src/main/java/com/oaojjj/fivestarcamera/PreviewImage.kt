...
data class PreviewImage(var path: String) {
    ...
    fun createBitmap() {
        ...
        val exifDegree = ImageController.instance()?.exifOrientationToDegrees(exifOrientation)
        bitmap = ImageController.instance()?.rotate(bitmap!!, exifDegree!!)!!
    }
